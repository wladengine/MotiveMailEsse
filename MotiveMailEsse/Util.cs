...
namespace MotiveMailEssay
{
    static class Util
    {
        ...
        static Util()
        {
            string connStr = "Data Source = srveducation; Initial Catalog=Priem2017;Integrated Security=False; User=MotivMailFileReader;Password=$MotivMail4FileReader.;Connect Timeout=300";
            //string connStr = "Data Source = srveducation; Initial Catalog=Priem2017_TEST;Integrated Security=True; Connect Timeout=300";
